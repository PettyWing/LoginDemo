...
import secondpage from './js/text.js';
                ...
                <View style={styles.container_phone}>
                    ...
                    <TextInput
                        ...
                        onChange={(event)=>{
                            ...
                            //console.log(this.state.phone.length+"   "+this.state.password.length);
                            if(this.state.password.length=="6"&&this.state.phone.length=="10")
                ...
                <View style={styles.container_password}>
                    <View style={styles.container_password1}>
                        ...
                        <TextInput
                            ...
                            onChange={(event)=>{
                                if(this.state.phone.length=="11"&&this.state.password.length=="5")
                                        this.setState({bt_passtate:true});
                                else
                                    this.setState({bt_passtate:false});
                            }}
